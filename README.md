...
```javascript
iterVercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-vercos@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-iter-special-vercos/tags). For example,

```javascript
iterVercos = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-vercos@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var iterVercos = require( 'path/to/vendor/umd/math-iter-special-vercos/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-vercos@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-vercos/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-iter-special-vercos/actions/workflows/test.yml?query=branch:v0.2.0
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/math-iter-special-vercos.svg
...
[deno-readme]: https://github.com/stdlib-js/math-iter-special-vercos/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/math-iter-special-vercos/tree/umd
[umd-readme]: https://github.com/stdlib-js/math-iter-special-vercos/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/math-iter-special-vercos/tree/esm
[esm-readme]: https://github.com/stdlib-js/math-iter-special-vercos/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/math-iter-special-vercos/blob/main/branches.md
